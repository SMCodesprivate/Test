...
import { verify_staff } from '../../all/functions';

export default function NewCurse() {
    async function loads() {
        var x = await verify_staff();
        if(x === false) return window.location.href = base_url+"/dashboard";
    }
    loads();
